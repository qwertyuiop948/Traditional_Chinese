...
namespace MasterActivator
{
    internal class MActivator
    {
        ...
        MItem qss = new MItem("Quicksilver Sash", "水銀飾帶", "qss", 3140, ItemTypeId.Purifier);
        MItem mercurial = new MItem("Mercurial Scimitar", "水銀彎刀", "mercurial", 3139, ItemTypeId.Purifier);
        MItem bilgewater = new MItem("Bilgewater Cutlass", "小彎刀", "bilge", 3144, ItemTypeId.Offensive, 450);
        MItem king = new MItem("Blade of the Ruined King", "殞落", "king", 3153, ItemTypeId.Offensive, 450);
        MItem youmus = new MItem("Youmuu's Ghostblade", "幽夢", "youmus", 3142, ItemTypeId.Offensive);
        MItem tiamat = new MItem("Tiamat", "提亞馬特", "tiamat", 3077, ItemTypeId.Offensive, 400);
        MItem hydra = new MItem("Ravenous Hydra", "九頭蛇", "hydra", 3074, ItemTypeId.Offensive, 400);
        MItem dfg = new MItem("Deathfire Grasp", "冥火", "dfg", 3128, ItemTypeId.Offensive, 750);
        MItem divine = new MItem("Sword of the Divine", "神聖之劍", "divine", 3131, ItemTypeId.Offensive);
        MItem hextech = new MItem("Hextech Gunblade", "科技槍", "hextech", 3146, ItemTypeId.Offensive, 700);
        MItem muramana = new MItem("Muramana", "魔宗", "muramana", 3042, ItemTypeId.Buff);
        MItem seraph = new MItem("Seraph's Embrace", "熾天使", "seraph", 3040, ItemTypeId.Deffensive);
        MItem zhonya = new MItem("Zhonya's Hourglass", "中亞", "zhonya", 3157, ItemTypeId.Deffensive);
        ...
        MItem mountain = new MItem("Face of the Mountain", "山靈守護", "mountain", 3401, ItemTypeId.Deffensive, 700); // falta range
        //Item frost = new Item("Frost Queen's Claim", "Frost Queen's", "frost", 3092, 850);
        MItem solari = new MItem("Locket of the Iron Solari", "鳥盾", "solari", 3190, ItemTypeId.Deffensive, 600);
        MItem mikael = new MItem("Mikael's Crucible", "米鍋", "Mikael", 3222, ItemTypeId.Purifier, 750);
        ...
        MItem hpPot = new MItem("Health Potion", "紅藥", "hpPot", 2003, ItemTypeId.HPRegenerator);
        MItem manaPot = new MItem("Mana Potion", "藍藥", "manaPot", 2004, ItemTypeId.ManaRegenerator);
        MItem biscuit = new MItem("Total Biscuit of Rejuvenation", "餅乾", "biscuit", 2010, ItemTypeId.HPRegenerator);
        ...
        MItem heal = new MItem("Heal", "治療術", "SummonerHeal", 0, ItemTypeId.DeffensiveSpell, 700); // 300? www.gamefaqs.com/pc/954437-league-of-legends/wiki/3-1-summoner-spells
        ...
        MItem ignite = new MItem("Ignite", "點燃", "SummonerDot", 0, ItemTypeId.OffensiveSpell, 600);
        MItem smite = new MItem("Smite", "懲戒", "SummonerSmite", 0, ItemTypeId.OffensiveSpell, 750);
        //SummonerExhaust  
        ...
        {
            Config = new Menu("Master活化劑", "masterActivator", true);

            Config.AddSubMenu(new Menu("淨化器", "purifiers"));
            ...
            Config.SubMenu("purifiers").AddItem(new MenuItem("defJustOnCombo", "在連招中使用")).SetValue(true);

            Config.AddSubMenu(new Menu("淨化異常狀態", "purify"));
            ...
            Config.SubMenu("purify").AddItem(new MenuItem("fear", "恐懼")).SetValue(true);
            ...
            Config.SubMenu("purify").AddItem(new MenuItem("taunt", "嘲諷")).SetValue(true);
            Config.SubMenu("purify").AddItem(new MenuItem("suppression", "壓製")).SetValue(true);
            Config.SubMenu("purify").AddItem(new MenuItem("stun", "眩暈")).SetValue(true);
            Config.SubMenu("purify").AddItem(new MenuItem("polymorph", "變形")).SetValue(false);
            Config.SubMenu("purify").AddItem(new MenuItem("silence", "沉默")).SetValue(false);

            Config.AddSubMenu(new Menu("懲戒對象", "smiteCfg"));
            ...
            {
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("AncientGolem", "藍buff")).SetValue(true);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("LizardElder", "紅buff")).SetValue(true);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("Dragon", "小龍")).SetValue(true);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("Worm", "大龍")).SetValue(true);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("GreatWraith", "大幽靈")).SetValue(false);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("Wraith", "小幽靈")).SetValue(false);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("Golem", "石頭人")).SetValue(false);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("GiantWolf", "三狼")).SetValue(false);

            }
            Config.SubMenu("smiteCfg").AddItem(new MenuItem("dSmite", "懲戒範圍")).SetValue(true);
            Config.SubMenu("smiteCfg").AddItem(new MenuItem("justAS", "始終開啟")).SetValue(false);

            Config.AddSubMenu(new Menu("攻擊物品", "offensive"));
            createMenuItem(ignite, 100, "offensive", false, false);
            Config.SubMenu("offensive").AddItem(new MenuItem("overIgnite", "在點燃後使用")).SetValue(false);
            ...
            Config.AddSubMenu(new Menu("加血|加藍", "regenerators"));
            ...
            Config.AddSubMenu(new Menu("團隊使用", "teamUseOn"));
            ...
            // Combo mode
            Config.AddSubMenu(new Menu("連招模式", "combo"));
            Config.SubMenu("combo").AddItem(new MenuItem("comboModeActive", "啟用活化劑")).SetValue(new KeyBind(32, KeyBindType.Press, true));

            // Target selector
            Config.AddSubMenu(new Menu("目標選擇", "targetSelector"));
            Config.SubMenu("targetSelector").AddItem(new MenuItem("targetMode", "")).SetValue(new StringList(new[] { "低血量", "高AD輸出", "高AP輸出", "附近隊友", "接近鼠標", "自動淨化", "低輸出", "輔助" }, 0));

            Config.AddItem(new MenuItem("predict", "預測 DMG")).SetValue(true);
            Config.AddItem(new MenuItem("enabled", "功能開啟or關閉")).SetValue(true);
