...
namespace Marksman
{
    internal class Tristana : Champion
    {
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("UseETH" + Id, "使用E (鎖定)").SetValue(new KeyBind("H".ToCharArray()[0],
                    KeyBindType.Toggle)));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawE" + Id, "E範圍").SetValue(new Circle(true, Color.CornflowerBlue)));
            return true;
        }
        ...
        public override bool MiscMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseRMI" + Id, "使用R打斷").SetValue(true));
            return true;
        }
