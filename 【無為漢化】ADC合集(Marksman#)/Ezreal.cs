...
namespace Marksman
{
    internal class Ezreal : Champion
    {
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("UseQTH" + Id, "使用Q (鎖定)").SetValue(new KeyBind("H".ToCharArray()[0],
                    KeyBindType.Toggle)));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("CastR" + Id, "半自動R(2000)").SetValue(new KeyBind("T".ToCharArray()[0],
                    KeyBindType.Press)));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawQ" + Id, "Q範圍").SetValue(new Circle(true, Color.FromArgb(100, 255, 0, 255))));
            config.AddItem(
                new MenuItem("DrawW" + Id, "W範圍").SetValue(new Circle(false, Color.FromArgb(100, 255, 255, 255))));
            return true;
        }
