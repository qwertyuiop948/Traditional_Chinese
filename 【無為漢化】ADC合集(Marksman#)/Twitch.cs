...
namespace Marksman
{
    internal class Twitch : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEC" + Id, "E層數").SetValue(true));
            return true;
        }
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseEH" + Id, "E層數").SetValue(false));
            return true;
        }
        ...
        {
            config.AddItem(
                new MenuItem("DrawW" + Id, "W範圍").SetValue(new Circle(true, Color.FromArgb(100, 255, 0, 255))));
            return true;
        }

        public override bool MiscMenu(Menu config)
        {
            config.AddItem(new MenuItem("UseEM" + Id, "可殺用E").SetValue(true));
            return true;
        }
