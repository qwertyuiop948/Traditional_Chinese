...
namespace Support.Plugins
{
    public class Janna : PluginBase
    {
        ...
        public override void MiscMenu(Menu config)
        {
            ...
            // build aa menu
            var aa = config.AddSubMenu(new Menu("使用 E 再攻擊ㄧ", "Misc.E.AA.Menu"));
            ...
            // build spell menu
            var dmg = config.AddSubMenu(new Menu("使用 E 的法術ㄧ", "Misc.E.Spell.Menu"));
            foreach (
                var spell in
        ...
        {
            config.AddBool("Gapcloser.Q", "使用 Q 防突進ㄧ", true);
            config.AddBool("Gapcloser.W", "使用 W 防突進ㄧ", true);

            config.AddBool("Interrupt.Q", "使用 Q 打斷", true);
            config.AddBool("Interrupt.R", "使用 R 打斷", true);
        }
    }
}