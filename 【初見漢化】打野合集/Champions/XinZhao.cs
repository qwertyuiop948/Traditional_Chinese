...
namespace Master
{
    class XinZhao : Program
    {
        ...
        public XinZhao()
        {
            ...
            Config.SubMenu("miscs").AddItem(new MenuItem(Name + "useInterR", "|使用R打斷|").SetValue(true));
            Config.SubMenu("miscs").AddItem(new MenuItem(Name + "killstealE", "|自動E擊殺|").SetValue(true));
