...
namespace Master
{
    class LeeSin : Program
    {
        ...
        public LeeSin()
        {
            ...
            Config.SubMenu("Orbwalker").SubMenu("lxOrbwalker_Modes").AddItem(new MenuItem(Name + "starActive", "明星連招").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Orbwalker").SubMenu("lxOrbwalker_Modes").AddItem(new MenuItem(Name + "insecMake", "可能是迴旋踢").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Orbwalker").SubMenu("lxOrbwalker_Modes").AddItem(new MenuItem(Name + "ksbrdr", "|搶大??小龍|").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));

            Config.AddSubMenu(new Menu("連招", "csettings"));
            Config.SubMenu("csettings").AddItem(new MenuItem(Name + "pusage", "使用被動").SetValue(false));
            ...
            Config.SubMenu("csettings").AddItem(new MenuItem(Name + "rusage", "使用R來擊殺").SetValue(true));
            ...
            Config.SubMenu("hsettings").AddItem(new MenuItem(Name + "harMode", "使用騷擾如果HP在以上|").SetValue(new Slider(20, 1)));
            ...
            Config.SubMenu("insettings").AddItem(new MenuItem(Name + "insecMode", "模式").SetValue(new StringList(new[] { "|附近的目標|", "|選擇的目標|", "|鼠標的位置|" })));
            Config.SubMenu("insettings").AddItem(new MenuItem(Name + "insecFlash", "如果無眼使用閃現").SetValue(true));
            Config.SubMenu("insettings").AddItem(new MenuItem(Name + "insecTowerR", "如果沒有英雄則踢向塔").SetValue(new Slider(1100, 500, 1500)));
            Config.SubMenu("insettings").AddItem(new MenuItem(Name + "drawInsec", "|迴旋踢線條方向|").SetValue(true));
            Config.SubMenu("insettings").AddItem(new MenuItem(Name + "drawInsecTower", "|顯示大招塔範圍|").SetValue(true));
            ...
            Config.SubMenu("miscs").AddItem(new MenuItem(Name + "smite", "|使用懲戒小兵接Q|").SetValue(true));
            ...
            Config.SubMenu("DrawSettings").AddItem(new MenuItem(Name + "drawKillable", "擊殺文本").SetValue(true));
            Config.SubMenu("DrawSettings").AddItem(new MenuItem(Name + "DrawQ", "Q 範圍").SetValue(false));
            Config.SubMenu("DrawSettings").AddItem(new MenuItem(Name + "DrawW", "W 範圍").SetValue(true));
            Config.SubMenu("DrawSettings").AddItem(new MenuItem(Name + "DrawE", "E 範圍").SetValue(false));
            Config.SubMenu("DrawSettings").AddItem(new MenuItem(Name + "DrawR", "R 範圍").SetValue(false));
