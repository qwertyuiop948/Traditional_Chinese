...
namespace Master
{
    class Jax : Program
    {
        ...
        public Jax()
        {
            ...
            Config.SubMenu("csettings").AddItem(new MenuItem(Name + "wuseMode", "W模式").SetValue(new StringList(new[] { "|AA後|", "|R後|" })));
            ...
            Config.SubMenu("csettings").AddItem(new MenuItem(Name + "ruseMode", "R模式").SetValue(new StringList(new[] { "|玩家HP|", "|敵人數量|" })));
            Config.SubMenu("csettings").AddItem(new MenuItem(Name + "ruseHp", "如果HP在使用R").SetValue(new Slider(50, 1)));
            Config.SubMenu("csettings").AddItem(new MenuItem(Name + "ruseEnemy", "如果以上的敵人使用R").SetValue(new Slider(2, 1, 4)));
            ...
            Config.SubMenu("LaneJungClear").AddItem(new MenuItem(Name + "useClearWMode", "W模式").SetValue(new StringList(new[] { "|AA後|", "|R後|" })));
            Config.SubMenu("LaneJungClear").AddItem(new MenuItem(Name + "useClearE", "使用 E").SetValue(true));

            Config.AddSubMenu(new Menu("雜項", "miscs"));
            Config.SubMenu("miscs").AddItem(new MenuItem(Name + "lasthitW", "使用W最後一擊|").SetValue(true));
            ...
            Config.SubMenu("miscs").AddItem(new MenuItem(Name + "SkinID", "|換皮膚|").SetValue(new Slider(8, 0, 8))).ValueChanged += SkinChanger;
