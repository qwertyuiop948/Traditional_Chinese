...
namespace Support.Plugins
{
    public class Blitzcrank : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("ComboCountR", "幾個敵人使用大招", 2, 1, 5);
        }

        public override void MiscMenu(Menu config)
        {
            config.AddBool("Misc.Q.OnAttack", "對目標AQ", true);
            config.AddBool("Misc.Q.Block", "使用Q限制接近目標", true);
            config.AddSlider("Misc.Q.Block.Distance", "Q限制的距離ㄧ", 400, 0, 800);
        }
        ...
        {
            config.AddBool("GapcloserE", "使用 E 中斷突進", true);
            config.AddBool("GapcloserR", "使用 R 中斷突進", true);
