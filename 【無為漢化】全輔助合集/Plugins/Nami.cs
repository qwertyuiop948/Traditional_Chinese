...
namespace Support.Plugins
{
    public class Nami : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("ComboHealthW", "健康恢復", 20, 1, 100);
        }
        ...
        public override void HarassMenu(Menu config)
        {
            ...
            config.AddSlider("HarassHealthW", "健康恢復", 20, 1, 100);
        }

        public override void MiscMenu(Menu config)
        {
            var sub = config.AddSubMenu(new Menu("使用 E 再攻擊", "Misc.E.AA.Menu"));
        ...
        {
            config.AddBool("GapcloserQ", "使用 Q 防突進", true);

            config.AddBool("InterruptQ", "使用 Q 打斷", true);
