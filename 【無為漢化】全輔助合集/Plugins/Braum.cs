...
namespace Support.Plugins
{
    public class Braum : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddSlider("Combo.R.Count", "敵人數量使用 R", 2, 1, 5);
        }
        ...
        {
            config.AddBool("Misc.Shield.Skill", "盾抵擋射擊ㄧ", true);
            config.AddBool("Misc.Shield.Target", "盾的目標", true);
        ...
        public override void InterruptMenu(Menu config)
        {
            ...
            config.AddBool("Gapcloser.R", "使用 R 防突進ㄧ", false);
